Avanade DevOps HOL - Continuous Integration and deployment with Visual Studio Team Services
====================================================================================
...
## Pre-requisites: ##
- Complete [Getting Started](README.md) hands on lab.
...
>-  NET Core Tool Installer <br>
    Change the version into 2.0.0
    Dont Change the Task Version
...
5. Go back to the Azure DevOps DevOpsHOL project and verify that another build has been automatically started.  Once the build is complete, check the build status and review the results.  If the build failed on the Test step, it might have been because you didn't run and fix the unit tests before checking in.  Go back and get the unit tests working and retry.
...
[Next Lab is Muli Staging](lab-2-multi-stage-deployments.md)